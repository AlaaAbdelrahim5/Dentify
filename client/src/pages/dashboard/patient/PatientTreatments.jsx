...
const PatientTreatments = () => {
  ...
  const stats = useMemo(() => {
    ...
    const totalCost = displayTreatments.reduce((sum, t) => sum + (t.totalAmount || 0), 0)
    const totalPaid = displayTreatments.reduce((sum, t) => sum + (t.paidAmount || 0), 0)
    const pendingPayments = totalCost - totalPaid
