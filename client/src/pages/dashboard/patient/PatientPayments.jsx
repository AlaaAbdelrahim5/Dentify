    ...
    <div className="space-y-6">
      ...
      <Card className={`p-6 ${isDarkMode ? 'bg-gradient-to-br from-teal-900/20 to-blue-900/20 border-teal-700' : 'bg-gradient-to-br from-teal-50 to-blue-50 border-teal-200'} border-2`}>
        <h2 className={`text-lg font-semibold flex items-center gap-2 mb-4 ${
          ...
          <FaFileInvoiceDollar className="text-teal-500" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
            <div>
              ...
              <p className={`text-2xl font-bold ${
                ...
                ${treatmentSummary.totalTreatmentCost.toFixed(2)}
              </p>
            </div>
            <div>
              <p className={isDarkMode ? 'text-gray-400' : 'text-gray-600'}>
              ...
              <p className="text-2xl font-bold text-green-600 dark:text-green-400">
                ${treatmentSummary.totalPaid.toFixed(2)}
              </p>
            </div>
            <div>
              <p className={isDarkMode ? 'text-gray-400' : 'text-gray-600'}>
              ...
              <p className={`text-2xl font-bold ${
                treatmentSummary.totalBalance > 0
                  ? 'text-orange-600 dark:text-orange-400'
                  : 'text-green-600 dark:text-green-400'
              }`}>
                ${treatmentSummary.totalBalance.toFixed(2)}
              </p>
            </div>
          </div>
        </div>

        {/* Treatment List with Balance */}
