      ...
      <div className="flex items-center justify-between mb-6">
        ...
        {unreadCount > 0 && (
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-linear-to-r from-blue-600 to-blue-500 text-white rounded-lg hover:from-blue-700 hover:to-blue-600 transition-all shadow-sm hover:shadow-md"
          >
      ...
      <div className="space-y-3">
        {notifications.length === 0 ? (
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-16 text-center">
            <div className="w-20 h-20 mx-auto mb-6 bg-linear-to-br from-blue-100 to-blue-50 dark:from-blue-900/30 dark:to-blue-800/20 rounded-full flex items-center justify-center">
          ...
          notifications.map((notification) => (
            ...
            >
              {!notification.read && (
                <div className="absolute left-0 top-0 bottom-0 w-1 bg-linear-to-b from-blue-600 to-blue-400" />
              )}
              <div className="p-5">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {notification.data && notification.data.type && (
                      <div className="mt-3">
                        <span className="inline-flex items-center px-3 py-1.5 bg-linear-to-r from-blue-50 to-blue-100 dark:from-blue-900/30 dark:to-blue-800/20 text-blue-700 dark:text-blue-400 text-xs font-semibold rounded-lg">
