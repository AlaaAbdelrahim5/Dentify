...
const EditPatientModal = ({ isOpen, onClose, onSave, patientData }) => {
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      disabled
                      className={`w-full pl-10 pr-3 py-2 border rounded-lg opacity-50 cursor-not-allowed ${
                        isDarkMode
                          ? 'border-gray-600 bg-gray-700 text-white'
                          : 'border-gray-300 bg-white text-gray-900'
                      }`}
                  ...
                  <p className="text-xs text-gray-400 mt-1">Phone number cannot be edited</p>
                </div>
