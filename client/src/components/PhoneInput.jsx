      ...
      <div className="relative">
        ...
        <div className="flex">
          ...
          <select
            ...
            className={`
              rounded-l-lg border border-r-0 border-gray-300 py-3 text-sm
              bg-white shadow-sm transition-all duration-200 appearance-none
              focus:border-teal-500 focus:ring-2 focus:ring-teal-500 focus:ring-opacity-20
              hover:border-gray-400 cursor-pointer text-transparent
          ...
          >
            {countryCodes.map((country) => (
              <option key={country.value} value={country.value} className="text-gray-900 py-1">
                {country.label}
              </option>
            ))}
          </select>
          ...
          <div className={`absolute top-1/2 transform -translate-y-1/2 pointer-events-none z-20 ${Icon ? 'left-10' : 'left-3'} text-sm font-medium text-gray-900`}>
          ...
          <input
            ...
            className={`
              flex-1 rounded-r-lg border border-gray-300 py-3 px-3 text-sm
