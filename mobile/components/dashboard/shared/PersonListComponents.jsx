...
export const PatientCard = ({ patient, isDarkMode, onPress }) => {
  ...
  const profileImagePath = patient.userId?.profileImage || patient.user?.profileImage || patient.profileImage;
  const profileImage = profileImagePath ? getImageUrl(profileImagePath) : null;
...
export const DentistCard = ({ dentist, isDarkMode, onPress }) => {
  const [imageError, setImageError] = useState(false);
  const profileImagePath = dentist.userId?.profileImage || dentist.user?.profileImage || dentist.profileImage;
  const profileImage = profileImagePath ? getImageUrl(profileImagePath) : null;
